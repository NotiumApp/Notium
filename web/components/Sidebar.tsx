...
export const Sidebar = ({
  ...
  return sidebarWidth !== null ? (
    ...
    //   }}
    //   defaultSize={{ width: `${sidebarWidth}px`, height: "500px" }}
    //   maxWidth="400px"
    //   minWidth={"250px"}
    // >
    <div className="w-72 bg-slate-100 h-screen fixed left-0 top-0 flex flex-col justify-between space-y-3 overflow-y-auto pt-4">
